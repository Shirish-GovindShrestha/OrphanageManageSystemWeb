...
public class RegisterController extends HttpServlet {
	...
	/**
	 * Handles the registration form display and submission.
	 */
	...
	/**
	 * Extracts user data from the registration form and creates a UserModel.
	 * Encrypts the password and retrieves image name.
	 */
	...
	/**
	 * Validates the registration form inputs. Returns an error message if
	...
	/**
	 * Uploads an image file from the HttpServletRequest.
	 * 
	...
	/**
	 * Handles errors by setting attributes for the error message and form fields,
	 * then forwards the request back to the registration page.
	 * 
