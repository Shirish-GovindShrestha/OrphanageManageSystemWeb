...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/account.css?v=1">
<link rel="stylesheet" type="text/css"
				...
				<div class="content-area">
							...
							<div class="profile-box">
								<div class="profile-photo">
									<img id="image-preview"
										...
										onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/resources/images/user/default.png'"/>
								</div>${username}</div>
						</div>
						<div class="change-pic">
							<input type="file" id="image" name="image"> <label
								for="image" class="custom-file-input">Select Image</label>
							<button type="submit">Confirm Update Picture</button>
						</div>
					</form>
					<form action="${pageContext.request.contextPath}/account"
						...
						<div class="row">
							...
							<div class="col">
								<label for="retypePassword">Retype New Password:</label> <input
