...
<div id="popup" class="modal">
    <div class="modal-content">
        ...
        <form method="post" action="${pageContext.request.contextPath}/dashboard" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <input type="text" id="schoolName" name="schoolName" value="${schoolName}" placeholder="School Name">
                </div>

                <div class="form-group">
                    <input type="text" id="grade" name="grade" value="${grade}" placeholder="Grade">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="performance" name="performance" >
                        ...
                        <option value="Poor" ${performance == 'Poor' ? 'selected' : ''}>Poor</option>
                    </select>
                </div>

                <div class="form-group">
                    <textarea id="remarks" name="remarks" placeholder="Remarks" rows="4">${remarks}</textarea>
                </div>
            </div>
    ...
    <div class="orphan-table">
        ...
        <table>
            ...
            <c:choose>
                    ...
                    <c:forEach var="orphan" items="${orphanList}">
                        <tr>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td colspan="2" style="text-align: center; color: #888;">No Education or School Data Available</td>
                                </c:otherwise>
                            </c:choose>

                            <td><a href="${pageContext.request.contextPath}/editOrphan?id=${orphan.orphanId}" class="edit-button">✏️</a>
                                <a href="deleteOrphan?id=${orphan.orphanId}" class="delete-button"
                ...
                <c:otherwise>
                    <tr>
                        <td colspan="10" style="text-align: center; color: #888;">No Orphans Found</td>
                    </tr>
                </c:otherwise>
            </c:choose>
        </table>
